...
@ =======================================================================
@ void fndsa_mq2poly_small_to_mod(unsigned logn, const int8_t *f, uint16_t *d)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_small_to_mod
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_small_to_mod, %function
fndsa_mq2poly_small_to_mod:
	...
	mov	r7, #0x00010001
fndsa_mq2poly_small_to_mod__L1:
	...
	strd	r5, r6, [r2], #8
	subs	r3, #4
	bne	fndsa_mq2poly_small_to_mod__L1

	pop	{ r4, r5, r6, r7 }
	bx	lr
	.size	fndsa_mq2poly_small_to_mod,.-fndsa_mq2poly_small_to_mod

@ =======================================================================
@ void fndsa_mq2poly_signed_to_mod(unsigned logn, uint16_t *d)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_signed_to_mod
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_signed_to_mod, %function
fndsa_mq2poly_signed_to_mod:
	@ This implementation actually normalizes to [1,q'] (strict internal
	@ representation).
	push	{ r4, r5, r6 }
	movs	r3, #1
	...
	mov	r2, #0x00010001
fndsa_mq2poly_signed_to_mod__L1:
	...
	strd	r4, r5, [r1], #8
	subs	r3, #4
	bne	fndsa_mq2poly_signed_to_mod__L1

	pop	{ r4, r5, r6 }
	bx	lr
	.size	fndsa_mq2poly_signed_to_mod,.-fndsa_mq2poly_signed_to_mod

@ =======================================================================
@ void fndsa_mq2poly_mul_ntt(unsigned logn, uint16_t *a, const uint16_t *b)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_mul_ntt
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_mul_ntt, %function
fndsa_mq2poly_mul_ntt:
...
fndsa_mq2poly_mul_ntt__L1:
	...
	subs	r3, #4
	bne	fndsa_mq2poly_mul_ntt__L1

	pop	{ r4, r5, r6, r7, r8, r10, pc }
	.size	fndsa_mq2poly_mul_ntt,.-fndsa_mq2poly_mul_ntt

@ =======================================================================
@ void fndsa_mq2poly_muladj_ntt(unsigned logn, uint16_t *a, const uint16_t *b)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_muladj_ntt
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_muladj_ntt, %function
fndsa_mq2poly_muladj_ntt:
	push.w	{ r4, r5, r6, r7, r8, r10, lr }
	movs	r3, #1
	lsls	r3, r0
	...
	@ set r2 to the end of b[].
	add	r2, r2, r3, lsl #1

fndsa_mq2poly_muladj_ntt__L1:
	@ A sequence of four ldr is faster than two ldrd or two ldm.
	ldr	r5, [r1]
	ldr	r6, [r1, #4]
	ldr.w	r7, [r2, #-4]!
	...
	@ Store the four output values.
	subs	r3, #4
	bne	fndsa_mq2poly_muladj_ntt__L1

	pop	{ r4, r5, r6, r7, r8, r10, pc }
	.size	fndsa_mq2poly_muladj_ntt,.-fndsa_mq2poly_muladj_ntt

@ =======================================================================
@ void fndsa_mq2poly_mulconst(unsigned logn, uint16_t *a, unsigned m)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_mulconst
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_mulconst, %function
fndsa_mq2poly_mulconst:
	...
	@ Convert r2 to Montgomery representation, and duplicate the
	@ result to both halves.
	mul	r12, r2, r14
	umaal	r14, r2, r12, r0
	add	r2, r2, r2, lsl #16

fndsa_mq2poly_mulconst__L1:
	ldm	r1, { r5, r6 }

	@ First pair of words (r5)
	@ Products over integers.
	smulbb	r4, r5, r2
	smultt	r5, r5, r2
	@ Montgomery reduction.
	...
	@ Store the four output values.
	subs	r3, #4
	bne	fndsa_mq2poly_mulconst__L1

	pop	{ r4, r5, r6, r7, pc }
	.size	fndsa_mq2poly_mulconst,.-fndsa_mq2poly_mulconst

@ =======================================================================
@ void fndsa_mq2poly_sub(unsigned logn, uint16_t *a, const uint16_t *b)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_sub
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_sub, %function
fndsa_mq2poly_sub:
	push.w	{ r4, r5, r6, r7, lr }
	movs	r3, #1
	lsls	r3, r0
...
fndsa_mq2poly_sub__L1:
	...
	subs	r3, #4
	bne	fndsa_mq2poly_sub__L1

	pop	{ r4, r5, r6, r7, pc }
	.size	fndsa_mq2poly_sub,.-fndsa_mq2poly_sub

@ =======================================================================
@ void fndsa_mq2poly_add(unsigned logn, uint16_t *a, const uint16_t *b)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_add
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_add, %function
fndsa_mq2poly_add:
	push.w	{ r4, r5, r6, r7, lr }
	movs	r3, #1
	lsls	r3, r0
...
fndsa_mq2poly_add__L1:
	...
	subs	r3, #4
	bne	fndsa_mq2poly_add__L1

	pop	{ r4, r5, r6, r7, pc }
	.size	fndsa_mq2poly_add,.-fndsa_mq2poly_add

@ =======================================================================
@ void fndsa_mq2poly_NTT(unsigned logn, uint16_t *d)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_NTT
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_NTT, %function
fndsa_mq2poly_NTT:
	...
	@ r8 <- &mq2_GM[1]
	adr	r8, fndsa_mq2poly_NTT__gmaddr_plus1
	ldr	r8, [r8]

	@ If n = 4, then skip directly to the specialized code for the
	@ last two iterations.
	cmp	r2, #4
	beq	fndsa_mq2poly_NTT__L4

fndsa_mq2poly_NTT__L1:
	@ Middle loop has m iterations.
	vmov	r3, s3
	lsl	r6, r3, #1     @ prepare m for next iteration
	vmov	s3, r6
fndsa_mq2poly_NTT__L2:
	ldrh	r6, [r8], #2   @ s <- mq2_GM[i + m]
	lsr	r7, r2, #1     @ r7 <- ht
fndsa_mq2poly_NTT__L3:
	...
	lsr	r2, r2, #1
	cmp	r2, #4
	bne	fndsa_mq2poly_NTT__L1

fndsa_mq2poly_NTT__L4:
	...
	@ At this point, r8 is correct (&mq2_GM[m]) and we set r7 to
	@ &mq2_GM[2*m] by adding 2*m (in bytes) to r8.
	add	r7, r8, r3, lsl #1

	@ r2 is free, since we know it contains 4.

fndsa_mq2poly_NTT__L5:
	...
	subs	r3, #1
	bne	fndsa_mq2poly_NTT__L5

fndsa_mq2poly_NTT__Lend:
	pop	{ r4, r5, r6, r7, r8, r10, r11, pc }
	.align	2
fndsa_mq2poly_NTT__gmaddr_plus1:
	.word	fndsa_mq2_GM + 2
	.size	fndsa_mq2poly_NTT,.-fndsa_mq2poly_NTT

@ =======================================================================
@ void fndsa_mq2poly_iNTT(unsigned logn, uint16_t *d)
@ =======================================================================

	.align	2
	.global	fndsa_mq2poly_iNTT
	.thumb
	.thumb_func
	.type	fndsa_mq2poly_iNTT, %function
fndsa_mq2poly_iNTT:
	push.w	{ r4, r5, r6, r7, r8, r10, r11, lr }
	...
	vmov	s2, r1
	@ m = n initially; we save m/2 to s3, and set r8 to &mq2_iGM[m/2]
	adr	r8, fndsa_mq2poly_iNTT__igmaddr
	ldr	r8, [r8]
	movs	r3, #1
	subs	r0, #1
	lsl	r0, r3, r0     @ r0 <- n/2 = 2^(logn-1)
	add.w	r8, r8, r0     @ r8 <- &mq2_iGM[n/4]
	lsr	r3, r0, #1
	vmov	s3, r3         @ s3 <- n/4
	...
	@ r8 is the pointer into mq2_GM[] for the second outer iteration.
	@ r7 is the pointer into mq2_GM[] for the first outer iteration.
	add	r7, r8, r3, lsl #1
...
fndsa_mq2poly_iNTT__L0:
	...
	cmp	r3, #1
	beq	fndsa_mq2poly_iNTT__Lend

fndsa_mq2poly_iNTT__L1:
	@ Rewind r1 to start of array.
	vmov	r1, s2

	@ m is in r3. r8 was left at &mq2_iGM[2*m]; we need to adjust it
	@ to &mq2_iGM[m/2], by subtracting 3*m (each element is two bytes).
	sub	r8, r8, r3, lsl #1
	sub.w	r8, r8, r3

	@ Middle loop has m/2 iterations (r3 is used as counter).
fndsa_mq2poly_iNTT__L2:
	ldrh	r6, [r8], #2   @ s <- mq2_iGM[i + m/2]
...
fndsa_mq2poly_iNTT__L3:
	...
	@ is negative.
	adds	r7, #2
	bne	fndsa_mq2poly_iNTT__L3

	@ We loop m/2 times
	subs	r3, #2
	bne	fndsa_mq2poly_iNTT__L2
	...
	vmov	s3, r3
	cmp	r3, #1
	bne	fndsa_mq2poly_iNTT__L1

fndsa_mq2poly_iNTT__Lend:
	pop	{ r4, r5, r6, r7, r8, r10, r11, pc }
	.align	2
fndsa_mq2poly_iNTT__igmaddr:
	.word	fndsa_mq2_iGM
	.size	fndsa_mq2poly_iNTT,.-fndsa_mq2poly_iNTT
